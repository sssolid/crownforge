-- src/infrastructure/repositories/query_templates/iseries/as400_cost_discrepancies.sql
-- AS400/Iseries query for cost discrepancies between systems
...
WHERE
    p.SRCOST IS NOT NULL
    AND lcc.ASCCST IS NOT NULL

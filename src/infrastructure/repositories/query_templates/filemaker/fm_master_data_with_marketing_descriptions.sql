...
SELECT
    ...
    "m"."VehicleUpperLower",
    "m"."VehicleInnerOuter",
    "md"."Jeep" AS "MarketingDescriptionJeep",
    "md"."NonJeep" AS "MarketingDescriptionNonJeep",
    "md"."Validation" AS "MarketingValidation",
    "md"."ReviewNotes" AS "MarketingReviewNotes"
FROM "Master" AS "m"
